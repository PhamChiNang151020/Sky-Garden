...
Rct_btn_NewGame = {150,250 + 150,75 + 475,475}, //250x75
  ...
  Rct_btn_Exit = {880,250 + 880,75 + 575,575},// btn trở về, mua
  ...
  Rct_btn_Bag = {1170,85 + 1170,73 + 280,280},//btn bên trái
  ...
  Rct_label_Container = {360,675 + 360,85 + 600,600},// khung chứa nhiệm vụ
  Rct_label_Mission = {400,506 + 400,604 + 67,67};
Rect //icon
icon_avt = {400,54 + 400,35 + 640,640},icon_star = {400,30 + 400,29 + 608,608},//btn mũi tên (Nơi đặt chậu hoa)
